...
def tests():
    ...
    cur = conn.cursor()
    cur.execute("DROP TABLE tests IF EXISTS;")
    cur.execute("CREATE TABLE tests (id serial PRIMARY KEY,nom_element char, nb_element integer,precision integer);")
